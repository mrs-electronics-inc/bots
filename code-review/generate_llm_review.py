            ...
            "change_requests": {
                ...
                "items": {
                    ...
                    "properties": {
                        ...
                        "old_start_line_number": {"type": "integer"},
                        "new_start_line_number": {"type": "integer"},
                        "old_end_line_number": {"type": "integer"},
                        "new_end_line_number": {"type": "integer"},
                    ...
                    "required": ["old_file_path", "new_file_path",
                                 "old_start_line_number", "new_start_line_number",
                                 "old_end_line_number", "new_end_line_number",
